# This task rotates KMS key version and associated secrets file for target args[:encryption_key].
#
# If args[:secret] is set, it also rotates the target secret.
...
task :rotate_secrets, [:encryption_key, :secret, :cmd] => [:configure_serviceaccount] do |taskname, args|
