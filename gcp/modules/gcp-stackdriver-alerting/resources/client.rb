...
ENV["GOOGLE_CLOUD_KEYFILE"] = "${serviceaccount_key}"
@project_id = '${project_id}'

begin
  notification_channels = JSON.parse('${notification_channels}')
rescue
  notification_channels = []
end

begin
  uptime_checks = JSON.parse('${uptime_checks}')
rescue
  uptime_checks = []
end

begin
  alert_policies = JSON.parse('${alert_policies}')
rescue
  alert_policies = []
end
...
alert_policies.each do |alert_policy|
  alert_policy = JSON.parse(alert_policy.gsub!("`", "\\\""))
